...
public class LuatMoToFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        nRootView=inflater.inflate(R.layout.fragment_luat_mo_to,null);

        list = nRootView.findViewById(R.id.lst_moto);
        arrayList = FlagTC.initFlagGX();
